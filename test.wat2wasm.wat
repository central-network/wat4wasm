(module
    ...
    (start $main) (func $main
        ...
        (memory.init 0 $wat2wasm/text (i32.const 0) (i32.const 0) (i32.const 460))    
    
        (table.set $extern (i32.const 1) (call $wat2wasm/text (i32.const 0) (i32.const 72)))
		(table.set $extern (i32.const 2) (call $wat2wasm/text (i32.const 72) (i32.const 24)))
		(table.set $extern (i32.const 3) (call $wat2wasm/text (i32.const 96) (i32.const 20)))
		(table.set $extern (i32.const 4) (call $wat2wasm/text (i32.const 116) (i32.const 32)))
		(table.set $extern (i32.const 5) (call $wat2wasm/text (i32.const 148) (i32.const 24)))
		(table.set $extern (i32.const 6) (call $wat2wasm/text (i32.const 172) (i32.const 48)))
		(table.set $extern (i32.const 7) (call $wat2wasm/text (i32.const 220) (i32.const 36)))
		(table.set $extern (i32.const 8) (call $wat2wasm/text (i32.const 256) (i32.const 16)))
		(table.set $extern (i32.const 9) (call $wat2wasm/text (i32.const 272) (i32.const 12)))
		(table.set $extern (i32.const 10) (call $wat2wasm/text (i32.const 284) (i32.const 24)))
		(table.set $extern (i32.const 11) (call $wat2wasm/text (i32.const 308) (i32.const 36)))
		(table.set $extern (i32.const 12) (call $wat2wasm/text (i32.const 344) (i32.const 12)))
		(table.set $extern (i32.const 13) (call $wat2wasm/text (i32.const 356) (i32.const 104)))    
    
        
        (memory.fill (i32.const 0) (i32.const 0) (i32.const 460))
