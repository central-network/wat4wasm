(module
    ...
    (start $main) (func $inlinefunction<f32>
		...
		(table.set $extern (i32.const 22) (call $wat2wasm/text (i32.const 712) (i32.const 60)))
		(table.set $extern (i32.const 23) (call $wat2wasm/text (i32.const 772) (i32.const 24)))    
    
        
        (memory.fill (i32.const 0) (i32.const 0) (i32.const 796))
        (data.drop $wat2wasm/text)    
    
        (global.set $ANY_TEXT_GLOBAL (table.get $extern (i32.const 22)))    
