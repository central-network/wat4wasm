 ...
 */
export function processCallBound(source, TableManager, extractRefExtern) {
    let result = source;
    ...
    while (true) {
        ...
        const initCode = generateInitCode(rawFuncName, currentTableIndex, TableManager, extractRefExtern);
 ...
 */
function generateInitCode(rawName, tableIndex, TableManager, extractRefExtern) {
 ...
 */
export function getBoundInitCodes() {
    return `
    (block $call_bound
