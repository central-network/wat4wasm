...
export const TableManager = {
     ...
     */
    generateSetter(index, valueWat) {
        return `(table.set ${TABLE_NAME} (i32.const ${index}) ${valueWat})`;
    },
    ...
    generateTableDefinition() {
        ...
        return `(table ${TABLE_NAME} ${size} ${size} externref)`;
    },
